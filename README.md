...
**Mac и Windows**. Статический сайт на GitHub Pages, без сборочных фреймворков и внешних
зависимостей (шрифты самохостятся, аналитики нет). Двуязычный: RU (`/`) и EN (`/en/`).
